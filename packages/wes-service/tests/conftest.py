...
from wes_service.config import Settings, get_settings
from wes_service.core.storage import StorageBackend
from wes_service.db.base import Base
from wes_service.db.session import get_db
...
def app(test_settings: Settings, test_db: AsyncSession, mock_storage: MagicMock):
    ...
    from wes_service.core.storage import get_storage_backend
    from wes_service.core.security import get_current_user
