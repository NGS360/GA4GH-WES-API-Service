...
from wes_service.api.deps import CurrentUser, DatabaseSession, Storage
from wes_service.api.routes._responses import BAD_REQUEST, ERRORS, NOT_FOUND
...
@router.get(
    ...
    responses=ERRORS | {400: BAD_REQUEST},
)
async def list_runs(
    db: DatabaseSession,
    user: CurrentUser,
...
@router.post(
    ...
    responses=ERRORS | {400: BAD_REQUEST, 404: NOT_FOUND},
)
